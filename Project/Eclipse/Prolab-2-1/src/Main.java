    ...
    public List<ArrayList<Integer>> temelFonksiyon(int[] nums, int baslangic) throws IOException {
        ...
        for (int j = 0; j < boyut; j++) {
            ...
            if (boyut == 1){
                ...
                double tekSehirIcinMaliyet = permArrayList.get(j).get(maliyetIndex)*2;
                clone.add( (int)tekSehirIcinMaliyet);
        ...
        System.out.println("Calisma suresi: "+(double)estimatedTime/1000+" saniye");
